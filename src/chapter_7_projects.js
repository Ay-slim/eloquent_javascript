...
VillageState.random = function(num_of_parcels) {
    const parcels = [];
    for(let ix=0; ix<num_of_parcels; ix++){
        let parcel = {place: randomPick(Object.keys(roadGraph))};
        do(parcel.address = randomPick(Object.keys(roadGraph))) while {
